  ...
  <div>
    <div class="top">
      <div class="orderStatus">
        <img src="/static/images/icon-success.png" class="icon-clock" />
        <span>支付成功</span>
      </div>
    </div>
    <div class="goods">
    ...
    <span class="originalPrice" v-if="orderInfo.materialPrice == null">￥{{goods.goodsMarketPrice}}</span>

    <span class="mataoriginal" v-if="orderInfo.materialPrice != null ">含素材费￥{{orderInfo.materialPrice}}</span>
                    <span class="goodsNum" v-if="orderInfo.materialPrice == null">x {{goods.goodsNum}}</span>
                </p>
              </div>
            </div>
          </div>
    ...
    <div class="goodsTotalWrapper">
      <ul class="cost">
        <li>
            ...
            <span class="gray">￥ {{ orderInfo.orderAmount }}</span>
        </li>
        <li>
            <span class="regular">运费</span>
            <span class="gray" v-if="orderInfo.orderFreight">￥{{orderInfo.orderFreight}}</span>
            <span class="gray" v-else>￥0</span>
        </li>
        <!-- <li v-if="orderInfo.materialPrice != null && orderInfo.materialPrice != 'undefined'">
            <span class="regular">素材费</span>
            <span class="gray">￥{{orderInfo.materialPrice}}</span>
        </li> -->
        <li>
            <span class="weight">需付费</span>
            <span class="orange">￥ {{orderInfo.payAmount}}</span>
        </li>
    </ul>
    </div>
    ...
    <div class="remark">
        ...
        <div class="remarkContent" v-if="orderInfo.orderRemarks">
            {{orderInfo.orderRemarks}}
        </div>
         <div class="remarkContent" v-else>
            
        </div>
    </div>
    <div class="fixedBottom">
      <div class="newAddress" @click="backHome">回到首页</div>
    </div>
  </div>
</template>
<script>

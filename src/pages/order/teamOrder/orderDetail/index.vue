<template>
  <div class="content">
    <div class="top">
      ...
      <p class="lastTime">剩20小时50分钟自动关闭</p>
    </div>
    <div class="address">
      <div class="addressIn">
        <div class="leftImg">
        ...
        <div class="addressContent">
          ...
          <div class="contentBot">收货地址: 豆腐干的地方大幅度发到付打发打发打发打发打发打发地方</div>
        </div>
      </div>
    </div>
    <div class="goods">
      <div class="goodsInfo">
        <div class="goodsCard">
          <img
            src="http://img0.imgtn.bdimg.com/it/u=2903586783,599922885&fm=26&gp=0.jpg"
            class="goodsImg"
          />
          <div class="goodsIntro">
            <div class="goodsName">按实际你少发设计的世纪东方上岛咖啡</div>
            <div class="teamNum">团队人数: 50人</div>
            <div class="goodsPrice">
              <span class="totalPrice">23.99</span>
              <span>（含素材费：￥23.00）</span>
            </div>
          </div>
        </div>
        <div class="applyAftersale">
          <div class="afterSale">查看成员</div>
        </div>
      </div>
    </div>
    ...
    <div class="invoince">
      ...
      <div class="invoinceType">
        ...
        <span class="checkInvoince">查看发票</span>
      </div>
      <div class="invoinceType">
        <span>发票内容：</span>
        <span>商品明细</span>
    ...
    <div class="orderInfo">
      <div class="orderNum">
        ...
        <span>2019-02-02 12:09:89</span>
      </div>
    </div>
    <div class="bottom">
      <!-- 待支付 -->
      <div>取消订单</div>
      <div class="confirm" @click="payNow(orderDetail.orderNo,orderDetail.payAmount)">立即付款</div>
    </div>
  </div>
</template>
<script>

        ...
        <div class="sheet">
         ...
         <div class="sheet">
            <ul class="tabList">
                ...
                <li class="border" @click="mySource"> 
                    <img src="/static/images/icon-source.png" alt class="source">
                    <span>我的素材</span>
                    <img src="/static/images/user-arrow-right.png" alt class="arrow">
                </li>
                <li class="border" @click="myProduct">  
                    <img src="/static/images/icon-cloth.png" alt class="cloth">
                    <span>我的成品</span>
                    <img src="/static/images/user-arrow-right.png" alt class="arrow">
                </li>
...
export default {
    ...
    methods:{
        ...
        _getUserInfo() {
         ...
         //设计师主页
         myPage() {
             let designerId = this.userInfo.id;
            let url = '/pages/designerDetail/main?isSelf=' + 1 + '&designerId=' + designerId;
            wx.navigateTo({url})
        },
        //钱包
        myWallet() {
             let url = '/pages/personalCenter/designer/designerWallet/main';
             wx.navigateTo({url})
        },
        //素材
        mySource() {
             let url = '/pages/personalCenter/designer/designerSource/main';
             wx.navigateTo({url})
        },
        //成品
        myProduct() {
             let url = '/pages/personalCenter/designer/designerProduct/main';
             wx.navigateTo({url})
        },
        //订单统计
        orderStatics() {
             let url = '/pages/personalCenter/designer/designerOrder/main';
             wx.navigateTo({url})
        },
    },
}

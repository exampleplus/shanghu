<template>
  ...
  <scroll-view class="scroll-bar" scroll-y="true" :style="{height: contentHeight + 'px'}"  lower-threshold="50" @scrolltolower="loadMoreData">
    ...
    <!-- <scroll-view  v-show="twoBar == 1" class="scrool-bar" scroll-y="true" :style="{height: contentHeight + 'px'}" lower-threshold="50" @scrolltolower="loadMoreGoods"> -->
    ...
    <!-- </scroll-view> -->
    <!-- <scroll-view  v-show="twoBar == 2" class="scrool-bar" scroll-y="true" :style="{height: contentHeight + 'px'}" lower-threshold="50" @scrolltolower="loadMoreSource"> -->
       <div class="sourceWrapper" v-show="twoBar == 2">
         <source-item :souceList="souceList" :hasCollectIcon="true" @detail="goSourceDetail" @collectSource="collectSource" @cancelCollectSource="cancelCollectSource"></source-item>
...
import { queryLowerScene, querySceneGoods, collect, cancelCollect } from '@/api/api'
